<template>
    <div class="login">
        ...
        <div class="content">
            ...
            <div class="middle">
                <el-checkbox size="large" label="记住密码" v-model="isRememberPass" @change="checkBoxChange" />
                <span>忘记密码</span>
            </div>

            <!-- 登录按钮 -->
            <el-button type="primary" size="large" class="login-button" @click="loginHandle"> 登录 </el-button>
        </div>
    </div>
</template>
